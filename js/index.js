...
const { flamethrower, dragonRush, earthquake, crunch, dragonPulse, blueFlare, fusionFlare, } = MOVES;
const { dragon, ground, fire } = TYPES;
//
let garchomp = new Pokemon("garchomp", [dragon, ground], adamant, [flamethrower, dragonRush, crunch, earthquake], {
    hp: 108,
    attack: 130,
    defense: 95,
    spAtk: 80,
...
let reshiram = new Pokemon("reshiram", [dragon, fire], modest, [flamethrower, fusionFlare, blueFlare, dragonPulse], {
    hp: 100,
    attack: 120,
    defense: 100,
    spAtk: 150,
...
reshiram.levelUp(99);
class ProgressBar {
    constructor(progressbar, totalHP) {
...
(function setUpPokemonOne(pokemonOne, pokemonTwo) {
    var _a, _b, _c, _d;
    ...
    // Pokemon One
    document.querySelector(".pokemon-one-name").innerHTML = pokemonOne.details().name.toUpperCase();
    const POneTypes = pokemonOne.details().types;
    document.querySelector(".pokemon-one-types .type-one").innerHTML = POneTypes[0].name.toUpperCase();
    ...
    document.querySelector(".pokemon-one-hp .total-hp").innerHTML = pokemonOne.details().stats.hp.toString();
    document.querySelector(".pokemon-one-battle-attack").innerHTML = pokemonOne.details().battleStats.stats.attack.toString();
    document.querySelector(".pokemon-one-battle-defense").innerHTML = pokemonOne.details().battleStats.stats.defense.toString();
    document.querySelector(".pokemon-one-battle-spatk").innerHTML = pokemonOne.details().battleStats.stats.spAtk.toString();
    document.querySelector(".pokemon-one-battle-spdef").innerHTML = pokemonOne.details().battleStats.stats.spDef.toString();
    document.querySelector(".pokemon-one-battle-speed").innerHTML = pokemonOne.details().battleStats.stats.speed.toString();
    document.querySelector(".pokemon-one-attack").innerHTML = pokemonOne.details().stats.attack.toString();
    document.querySelector(".pokemon-one-defense").innerHTML = pokemonOne.details().stats.defense.toString();
    document.querySelector(".pokemon-one-spatk").innerHTML = pokemonOne.details().stats.spAtk.toString();
    document.querySelector(".pokemon-one-spdef").innerHTML = pokemonOne.details().stats.spDef.toString();
    document.querySelector(".pokemon-one-speed").innerHTML = pokemonOne.details().stats.speed.toString();
    ...
    (_a = POMoveOne.querySelector(".use")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", (e) => {
        ...
        POMoveOne.querySelector(".PP .current-PP").innerHTML = pokemonOne.details().battleStats.moves[0].PP.toString();
        document.querySelector(".pokemon-two-hp .current-hp").innerHTML = pokemonTwo.details().battleStats.stats.hp.toString();
...
(function setUpPokemonTwo(pokemonOne, pokemonTwo) {
    var _a, _b, _c, _d;
    ...
    document.querySelector(".pokemon-two-types .type-one").innerHTML = PTTypes[0].name.toUpperCase();
    document.querySelector(".pokemon-two-types .type-two").innerHTML =
        PTTypes[1].name.toUpperCase() || "";
    document.querySelector(".pokemon-two-hp .current-hp").innerHTML = pokemonTwo.details().battleStats.stats.hp.toString();
    document.querySelector(".pokemon-two-hp .total-hp").innerHTML = pokemonTwo.details().stats.hp.toString();
    document.querySelector(".pokemon-two-battle-attack").innerHTML = pokemonTwo.details().battleStats.stats.attack.toString();
    document.querySelector(".pokemon-two-battle-defense").innerHTML = pokemonTwo.details().battleStats.stats.defense.toString();
    document.querySelector(".pokemon-two-battle-spatk").innerHTML = pokemonTwo.details().battleStats.stats.spAtk.toString();
    document.querySelector(".pokemon-two-battle-spdef").innerHTML = pokemonTwo.details().battleStats.stats.spDef.toString();
    document.querySelector(".pokemon-two-battle-speed").innerHTML = pokemonTwo.details().battleStats.stats.speed.toString();
    document.querySelector(".pokemon-two-attack").innerHTML = pokemonTwo.details().stats.attack.toString();
    document.querySelector(".pokemon-two-defense").innerHTML = pokemonTwo.details().stats.defense.toString();
    document.querySelector(".pokemon-two-spatk").innerHTML = pokemonTwo.details().stats.spAtk.toString();
    document.querySelector(".pokemon-two-spdef").innerHTML = pokemonTwo.details().stats.spDef.toString();
    document.querySelector(".pokemon-two-speed").innerHTML = pokemonTwo.details().stats.speed.toString();
